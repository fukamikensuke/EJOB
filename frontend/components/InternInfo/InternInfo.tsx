          ...
          <Stack divider={<StackDivider />} spacing="4">
            <Box>
              <Heading size="xs" textTransform="uppercase">
                <Badge variant="outline" colorScheme="green" fontSize="1.3em">
                  企業名
                </Badge>
              </Heading>
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.companyName}
                />
              </Text>
            </Box>
            <Box>
            ...
            <Box>
              ...
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.internType}
                />
              </Text>
            </Box>
            <Box>
            ...
            <Box>
              ...
              <Text pt="2" fontSize="l">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.internContents}
                />
              </Text>
            </Box>
          </Stack>
        ...
        <CardBody>
          <Stack divider={<StackDivider />} spacing="4">
            <Box>
              <Heading size="xs" textTransform="uppercase">
                <Badge variant="outline" colorScheme="green" fontSize="1.3em">
                  選考時の趣味開発やハッカソン等での開発経験
                </Badge>
              </Heading>
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.developEx}
                />
              </Text>
            </Box>
            <Box>
              ...
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.internEx}
                />
              </Text>
            </Box>
            <Box>
              ...
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.internTestPreparation}
                />
              </Text>
            </Box>
            <Box>
              <Heading size="xs" textTransform="uppercase">
                <Badge variant="outline" colorScheme="green" fontSize="1.3em">
                  インターンに参加したことでその先の選考の免除があったか
                </Badge>
              </Heading>
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.isSelectionExemption}
                />
              </Text>
            </Box>
            <Box>
              ...
              <Text pt="2" fontSize="sl">
                <CustomText
                  width={WLarge}
                  text={displayInternInfoAPI.selectionExemptionContents}
                />
              </Text>
            </Box>
          </Stack>
        ...
        <CardBody>
          <Stack divider={<StackDivider />} spacing="10">
            <Box>
              <CustomText
                width={WLarge}
                text={displayInternInfoAPI.impressions}
              />
            </Box>
          </Stack>
        </CardBody>
